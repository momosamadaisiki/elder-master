<script setup>
  ...
  const showAddDialog = () => {
    ...
    title.value = '添加'
    examItem.value = {resultType: 0, status: 1, sort: 0}
  }
...
<template>
  <el-card class="">
    <template #header>
      <div class="page-header">
        <div class="page-title">体检项目管理</div>
        <div class="header">
  ...
  <!--添加、编辑弹出框-->
  <el-dialog v-model="dialogFormVisible" :title="title" width="640" :lock-scroll="false" :close-on-click-modal="false">
