...
public class AliOSSUtil {
    ...
    private static final String ACCESS_KEY_ID = "LTAI5t9B33CGkyaic2CVHBoz";
    private static final String ACCESS_KEY_SECRET = "P0mRfnNw5e8So4RAPLF0fPJ3sSAzS1";
    // 填写Bucket名称，例如examplebucket。
    private static final String BUCKET_NAME = "momosama";
